(function () {
  ...
  function getRelativePrefix() {
    return document.querySelector('.brand[href^="../"], .nav a[href^="../"], .footer a[href^="../"]') ? '../' : './';
  }
  ...
  function getChatbotUrls() {
    ...
    return {
      contact: prefix + 'kontakt/index.html',
      services: prefix + 'leistungen/index.html',
      privacy: prefix + 'datenschutz/index.html',
      imprint: prefix + 'impressum/index.html'
    };
  }
